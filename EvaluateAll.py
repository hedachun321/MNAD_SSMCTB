...
parser.add_argument('--model_dir', type=str, default='./exp/ped2/pred/log_ssmctb_all',
                    help='directory of model')
parser.add_argument('--m_items_dir', type=str, default='./exp/ped2/pred/log_ssmctb/keys_ssmctb_130.pt',
                    help='directory of model')
...
for model_file in model_files:
    ...
    m_items_path = model_path
    m_items_path = m_items_path.replace("model_", "keys_")
    m_items_path = m_items_path.replace("pth", "pt")
    ...
    print('Evaluation of', args.dataset_type, model_file)
